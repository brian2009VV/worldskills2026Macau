...
def go_through_hole(L, R, x):
    ...
    if m_point == 95 or m_point == 105:
        f.RelativeXYW([85, 0, 0], v_f, 5, 1.5)
        return 100
        ...
        f.RelativeXYW([abs(x - m_point) + 5, 0, 0, 0], v_h, 5, 1.5)
        f.RelativeXYW([0, 0, 90], v_h, 5, 1.5)
        f.RelativeXYW([85, 0, 0], v_f, 5, 1.5)
    else:
        f.RelativeXYW([0, 0, 90], v_h, 5, 1.5)
...
if __name__ == "__main__":
    ...
    f.RelativeXYW([0, 0, -90], v_h, 5, 1.5)
    f.CalibrateFRONT(wall_len // 2 - disLO)
    #f.RelativeXYW([65, 0, 0], v_h, 5, 1.5)
    f.RelativeXYW([0, 0, 90], v_h, 5, 1.5)
    write_Wall(0, 100, 7)
    L, R = check_hole(0)
    ...
    for i in range(3):
        ...
        if x == 100:
            ...
            f.RelativeXYW([0, 0, -90], v_h, 5, 1.5)
            f.RelativeXYW([x - 100 + 5, 0, 0], v_h, 5, 1.5)
            f.RelativeXYW([0, 0, 90], v_h, 5, 1.5)
        else:
            f.RelativeXYW([0, 0, 90], v_h, 5, 1.5)
            f.RelativeXYW([100 - x + 5, 0, 0], v_h, 5, 1.5)
            f.RelativeXYW([0, 0, -90], v_h, 5, 1.5)
